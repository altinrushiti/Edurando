<template>
    <edit-page></edit-page>
    <div
            class="min-h-screen bg-gray-100 dark:bg-[#181818] flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 font-font-family">
        <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900 dark:text-[#b5a9fc]">Add Topic with Subject</h2>
        <div class="mt-8 space-y-6">
            <div>
                <form class="flex flex-col items-center w-full">
                    <div class="w-1/2">
                        <label for="subject" class="text-black dark:text-[#b5a9fc] font-font-family p-2">Subject</label>
                    ...
                    <div class="flex justify-center mt-7 space-x-4">
                        <div class="mt-6 mr-8 text-center flex justify-center text-white dark:text-black">
                            <button @click="goBack">
                                <font-awesome-icon :icon="['fas', 'arrow-left']" class="text-4xl text-gray-900 dark:text-[#b5a9fc]"/>
                            </button>
                        </div>
                        <div class="mt-6 ml-8 text-center flex justify-center text-white dark:text-black">
                            <button @click="addSubjectTopic" class="w-full">
                                <font-awesome-icon :icon="['fas', 'check']" class="text-4xl text-gray-900 dark:text-[#b5a9fc]"/>
                            </button>
                        </div>
                    </div>
                </form>
