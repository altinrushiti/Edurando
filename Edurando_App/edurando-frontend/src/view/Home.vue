...
/*export default {
  data() {
    return {
      rating: 5.0 // Assuming the rating value is 5.0, you can update it dynamically
    };
  }
};*/
...
<template>
  <!--<div  class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-[100px]">
    <a href="#">
