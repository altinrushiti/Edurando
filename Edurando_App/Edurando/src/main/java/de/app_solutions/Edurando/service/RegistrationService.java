...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        if (!uniqueMail) {
            ...
            return String.format("%b,%s", false, final_msg.substring(0, final_msg.length() - 1));
            ...
            System.err.printf("%b,Registration was successful", true);
            return String.format("%b,Registration was successful", true);
        }
    }
